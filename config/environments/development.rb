Rails.application.configure do
  ...
  config.after_initialize do
    ...
    Bullet.slack = { webhook_url: 'https://hooks.slack.com/services/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', channel: '#server', username: 'GPIU-National: Bullet Notifier' }
    # Bullet.sentry = true
    # Bullet.growl = true
