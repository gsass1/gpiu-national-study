  ...
  def antibiotic_groups
    {
      ...
      I18n.t('shared.appendix_antibiotic.fifth_generation_cephalosporin.group') =>
          [
            [I18n.t('shared.appendix_antibiotic.fifth_generation_cephalosporin.ceftaroline_fosamil'),
             "Ceftaroline\ fosamil"],
      ...
      I18n.t('shared.appendix_antibiotic.sulfonamide.group') =>
          [
            ...
            [I18n.t('shared.appendix_antibiotic.sulfonamide.trimephtoprim_sulfamethoxazole'),
             "Trimephtoprim-\ Sulfamethoxazole"]
          ],
