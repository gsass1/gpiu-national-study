module RegionalAdminAuthenticated
  ...
  def authenticate_regional_admin_user!
    redirect_to root_path, flash: { alert: "You are not a regional admin for this country." } unless (current_user.admin? || current_user.has_role?(:regional_admin, current_country))
  end
end
