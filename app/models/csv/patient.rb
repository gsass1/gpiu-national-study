class Csv::Patient < Csv::Writer
  def row(p)
    ...
    if p.uti_ssi?
      ...
      col 'uti.5.ii.a.10.iii', p.uti_questionnaire.get_appendix_antibiotics_at(0).macrolides_erythromycin
      ...
      col 'uti.5.ii.a.13.iii', p.uti_questionnaire.get_appendix_antibiotics_at(0).penicillins_nafcillin
      col 'uti.5.ii.a.13.iv', p.uti_questionnaire.get_appendix_antibiotics_at(0).penicillins_oxacillin
      col 'uti.5.ii.a.13.v', p.uti_questionnaire.get_appendix_antibiotics_at(0).penicillins_ticarcillin
      col 'uti.5.ii.a.13.vi', p.uti_questionnaire.get_appendix_antibiotics_at(0).penicillins_penicillin_g
      col 'uti.5.ii.a.13.vii', p.uti_questionnaire.get_appendix_antibiotics_at(0).penicillins_methicillin
      col 'uti.5.ii.a.13.viii', p.uti_questionnaire.get_appendix_antibiotics_at(0).penicillins_penicillin_combinations
      col 'uti.5.ii.a.13.viii.a', p.uti_questionnaire.get_appendix_antibiotics_at(0).penicillins_penicillin_combinations_amoxicillin_clavulunate
      ...
      col 'uti.5.ii.a.15.iii', p.uti_questionnaire.get_appendix_antibiotics_at(0).quinolones_gatifloxacin
      col 'uti.5.ii.a.15.iv', p.uti_questionnaire.get_appendix_antibiotics_at(0).quinolones_gemifloxacin
      col 'uti.5.ii.a.15.v', p.uti_questionnaire.get_appendix_antibiotics_at(0).quinolones_levofloxacin
      col 'uti.5.ii.a.15.vi', p.uti_questionnaire.get_appendix_antibiotics_at(0).quinolones_lomefloxacin
      col 'uti.5.ii.a.15.vii', p.uti_questionnaire.get_appendix_antibiotics_at(0).quinolones_moxifloxacin
      ...
      col 'uti.5.ii.a.18.iii', p.uti_questionnaire.get_appendix_antibiotics_at(0).antimycobacterial_drugs_capreomycin
      col 'uti.5.ii.a.18.iv', p.uti_questionnaire.get_appendix_antibiotics_at(0).antimycobacterial_drugs_cycloserine
      col 'uti.5.ii.a.18.v', p.uti_questionnaire.get_appendix_antibiotics_at(0).antimycobacterial_drugs_ethembutol
      col 'uti.5.ii.a.18.vi', p.uti_questionnaire.get_appendix_antibiotics_at(0).antimycobacterial_drugs_ethionamide
      col 'uti.5.ii.a.18.vii', p.uti_questionnaire.get_appendix_antibiotics_at(0).antimycobacterial_drugs_isoniazid
      ...
      col 'ssi.5.ii.a.1', p.ssi_questionnaire.get_appendix_antibiotics_at(0).aminoglycosides
      col 'ssi.5.ii.a.1.i', p.ssi_questionnaire.get_appendix_antibiotics_at(0).aminoglycosides_gentamicin
      col 'ssi.5.ii.a.1.ii', p.ssi_questionnaire.get_appendix_antibiotics_at(0).aminoglycosides_amikacin
      col 'ssi.5.ii.a.1.iii', p.ssi_questionnaire.get_appendix_antibiotics_at(0).aminoglycosides_other
      col 'ssi.5.ii.a.2', p.ssi_questionnaire.get_appendix_antibiotics_at(0).carbapenems
      col 'ssi.5.ii.a.2.i', p.ssi_questionnaire.get_appendix_antibiotics_at(0).carbapenems_ertapenem
      col 'ssi.5.ii.a.2.ii', p.ssi_questionnaire.get_appendix_antibiotics_at(0).carbapenems_imipenem
      col 'ssi.5.ii.a.2.iii', p.ssi_questionnaire.get_appendix_antibiotics_at(0).carbapenems_doripenem
      col 'ssi.5.ii.a.2.iv', p.ssi_questionnaire.get_appendix_antibiotics_at(0).carbapenems_meropenem
      col 'ssi.5.ii.a.3', p.ssi_questionnaire.get_appendix_antibiotics_at(0).first_generation_cephalosporins
      col 'ssi.5.ii.a.3.i', p.ssi_questionnaire.get_appendix_antibiotics_at(0).first_generation_cephalosporins_cefadroxil
      col 'ssi.5.ii.a.3.ii', p.ssi_questionnaire.get_appendix_antibiotics_at(0).first_generation_cephalosporins_cefazolin
      col 'ssi.5.ii.a.3.iii', p.ssi_questionnaire.get_appendix_antibiotics_at(0).first_generation_cephalosporins_cefalexin
      col 'ssi.5.ii.a.4', p.ssi_questionnaire.get_appendix_antibiotics_at(0).second_generation_cephalosporins
      col 'ssi.5.ii.a.4.i', p.ssi_questionnaire.get_appendix_antibiotics_at(0).second_generation_cephalosporins_cefaclor
      col 'ssi.5.ii.a.4.ii', p.ssi_questionnaire.get_appendix_antibiotics_at(0).second_generation_cephalosporins_cefprozil
      col 'ssi.5.ii.a.4.iii', p.ssi_questionnaire.get_appendix_antibiotics_at(0).second_generation_cephalosporins_cefuroxime
      col 'ssi.5.ii.a.5', p.ssi_questionnaire.get_appendix_antibiotics_at(0).third_generation_cephalosporins
      col 'ssi.5.ii.a.5.i', p.ssi_questionnaire.get_appendix_antibiotics_at(0).third_generation_cephalosporins_cefixim
      col 'ssi.5.ii.a.5.ii', p.ssi_questionnaire.get_appendix_antibiotics_at(0).third_generation_cephalosporins_cefdinir
      col 'ssi.5.ii.a.5.iii', p.ssi_questionnaire.get_appendix_antibiotics_at(0).third_generation_cephalosporins_cefotaxime
      col 'ssi.5.ii.a.5.iv', p.ssi_questionnaire.get_appendix_antibiotics_at(0).third_generation_cephalosporins_cefpodoxime
      col 'ssi.5.ii.a.5.v', p.ssi_questionnaire.get_appendix_antibiotics_at(0).third_generation_cephalosporins_ceftazidime
      col 'ssi.5.ii.a.5.vi', p.ssi_questionnaire.get_appendix_antibiotics_at(0).third_generation_cephalosporins_ceftibuten
      col 'ssi.5.ii.a.5.vii', p.ssi_questionnaire.get_appendix_antibiotics_at(0).third_generation_cephalosporins_ceftriaxone
      col 'ssi.5.ii.a.6', p.ssi_questionnaire.get_appendix_antibiotics_at(0).fourth_generation_cephalosporins
      col 'ssi.5.ii.a.6.i', p.ssi_questionnaire.get_appendix_antibiotics_at(0).fourth_generation_cephalosporins_cefepime
      col 'ssi.5.ii.a.7', p.ssi_questionnaire.get_appendix_antibiotics_at(0).fifth_generation_cephalosporins
      col 'ssi.5.ii.a.7.i', p.ssi_questionnaire.get_appendix_antibiotics_at(0).fifth_generation_cephalosporins_ceftaroline_fosamil
      col 'ssi.5.ii.a.7.ii', p.ssi_questionnaire.get_appendix_antibiotics_at(0).fifth_generation_cephalosporins_ceftobiprole
      col 'ssi.5.ii.a.8', p.ssi_questionnaire.get_appendix_antibiotics_at(0).glycopeptides
      col 'ssi.5.ii.a.8.i', p.ssi_questionnaire.get_appendix_antibiotics_at(0).glycopeptides_teicoplanin
      col 'ssi.5.ii.a.8.ii', p.ssi_questionnaire.get_appendix_antibiotics_at(0).glycopeptides_vancomycin
      col 'ssi.5.ii.a.8.iii', p.ssi_questionnaire.get_appendix_antibiotics_at(0).glycopeptides_telavancin
      col 'ssi.5.ii.a.9', p.ssi_questionnaire.get_appendix_antibiotics_at(0).lincosamides
      col 'ssi.5.ii.a.9.i', p.ssi_questionnaire.get_appendix_antibiotics_at(0).lincosamides_clindamycin
      col 'ssi.5.ii.a.9.ii', p.ssi_questionnaire.get_appendix_antibiotics_at(0).lincosamides_lincomycin
      col 'ssi.5.ii.a.10', p.ssi_questionnaire.get_appendix_antibiotics_at(0).macrolides
      col 'ssi.5.ii.a.10.i', p.ssi_questionnaire.get_appendix_antibiotics_at(0).macrolides_azithromycin
      col 'ssi.5.ii.a.10.ii', p.ssi_questionnaire.get_appendix_antibiotics_at(0).macrolides_clarithromycin
      col 'ssi.5.ii.a.10.iii', p.ssi_questionnaire.get_appendix_antibiotics_at(0).macrolides_erythromycin
      col 'ssi.5.ii.a.10.iv', p.ssi_questionnaire.get_appendix_antibiotics_at(0).macrolides_roxithromycin
      col 'ssi.5.ii.a.10.v', p.ssi_questionnaire.get_appendix_antibiotics_at(0).macrolides_telithromycin
      col 'ssi.5.ii.a.10.vi', p.ssi_questionnaire.get_appendix_antibiotics_at(0).macrolides_spiramycin
      col 'ssi.5.ii.a.11', p.ssi_questionnaire.get_appendix_antibiotics_at(0).monobactams
      col 'ssi.5.ii.a.11.i', p.ssi_questionnaire.get_appendix_antibiotics_at(0).monobactams_aztreonam
      col 'ssi.5.ii.a.12', p.ssi_questionnaire.get_appendix_antibiotics_at(0).nitrofurans
      col 'ssi.5.ii.a.12.i', p.ssi_questionnaire.get_appendix_antibiotics_at(0).nitrofurans_furazolidine
      col 'ssi.5.ii.a.12.ii', p.ssi_questionnaire.get_appendix_antibiotics_at(0).nitrofurans_nitrofurantoin
      col 'ssi.5.ii.a.13', p.ssi_questionnaire.get_appendix_antibiotics_at(0).penicillins
      col 'ssi.5.ii.a.13.i', p.ssi_questionnaire.get_appendix_antibiotics_at(0).penicillins_amoxicillin
      col 'ssi.5.ii.a.13.ii', p.ssi_questionnaire.get_appendix_antibiotics_at(0).penicillins_ampicillin
      col 'ssi.5.ii.a.13.iii', p.ssi_questionnaire.get_appendix_antibiotics_at(0).penicillins_nafcillin
      col 'ssi.5.ii.a.13.iv', p.ssi_questionnaire.get_appendix_antibiotics_at(0).penicillins_oxacillin
      col 'ssi.5.ii.a.13.v', p.ssi_questionnaire.get_appendix_antibiotics_at(0).penicillins_ticarcillin
      col 'ssi.5.ii.a.13.vi', p.ssi_questionnaire.get_appendix_antibiotics_at(0).penicillins_penicillin_g
      col 'ssi.5.ii.a.13.vii', p.ssi_questionnaire.get_appendix_antibiotics_at(0).penicillins_methicillin
      col 'ssi.5.ii.a.13.viii', p.ssi_questionnaire.get_appendix_antibiotics_at(0).penicillins_penicillin_combinations
      col 'ssi.5.ii.a.13.viii.a', p.ssi_questionnaire.get_appendix_antibiotics_at(0).penicillins_penicillin_combinations_amoxicillin_clavulunate
      col 'ssi.5.ii.a.13.viii.b', p.ssi_questionnaire.get_appendix_antibiotics_at(0).penicillins_penicillin_combinations_ampicillin_sulbactam
      col 'ssi.5.ii.a.13.viii.c', p.ssi_questionnaire.get_appendix_antibiotics_at(0).penicillins_penicillin_combinations_piperacillin_tazobactam
      col 'ssi.5.ii.a.13.viii.d', p.ssi_questionnaire.get_appendix_antibiotics_at(0).penicillins_penicillin_combinations_ticarcillin_claculunate
      col 'ssi.5.ii.a.14', p.ssi_questionnaire.get_appendix_antibiotics_at(0).polypeptides
      col 'ssi.5.ii.a.14.i', p.ssi_questionnaire.get_appendix_antibiotics_at(0).polypeptides_bacitracin
      col 'ssi.5.ii.a.14.ii', p.ssi_questionnaire.get_appendix_antibiotics_at(0).polypeptides_colistin
      col 'ssi.5.ii.a.14.iii', p.ssi_questionnaire.get_appendix_antibiotics_at(0).polypeptides_polymyxin_b
      col 'ssi.5.ii.a.15', p.ssi_questionnaire.get_appendix_antibiotics_at(0).quinolones
      col 'ssi.5.ii.a.15.i', p.ssi_questionnaire.get_appendix_antibiotics_at(0).quinolones_ciprofloxacin
      col 'ssi.5.ii.a.15.ii', p.ssi_questionnaire.get_appendix_antibiotics_at(0).quinolones_enoxacin
      col 'ssi.5.ii.a.15.iii', p.ssi_questionnaire.get_appendix_antibiotics_at(0).quinolones_gatifloxacin
      col 'ssi.5.ii.a.15.iv', p.ssi_questionnaire.get_appendix_antibiotics_at(0).quinolones_gemifloxacin
      col 'ssi.5.ii.a.15.v', p.ssi_questionnaire.get_appendix_antibiotics_at(0).quinolones_levofloxacin
      col 'ssi.5.ii.a.15.vi', p.ssi_questionnaire.get_appendix_antibiotics_at(0).quinolones_lomefloxacin
      col 'ssi.5.ii.a.15.vii', p.ssi_questionnaire.get_appendix_antibiotics_at(0).quinolones_moxifloxacin
      col 'ssi.5.ii.a.15.viii', p.ssi_questionnaire.get_appendix_antibiotics_at(0).quinolones_nalidixic_acid
      col 'ssi.5.ii.a.15.ix', p.ssi_questionnaire.get_appendix_antibiotics_at(0).quinolones_norfloxacin
      col 'ssi.5.ii.a.15.x', p.ssi_questionnaire.get_appendix_antibiotics_at(0).quinolones_ofloxacin
      col 'ssi.5.ii.a.16', p.ssi_questionnaire.get_appendix_antibiotics_at(0).sulfonamides
      col 'ssi.5.ii.a.16.i', p.ssi_questionnaire.get_appendix_antibiotics_at(0).sulfonamides_sulfamethoxazole
      col 'ssi.5.ii.a.16.ii', p.ssi_questionnaire.get_appendix_antibiotics_at(0).sulfonamides_trimephtoprim_sulfamethoxazole
      col 'ssi.5.ii.a.17', p.ssi_questionnaire.get_appendix_antibiotics_at(0).tetracyclines
      col 'ssi.5.ii.a.17.i', p.ssi_questionnaire.get_appendix_antibiotics_at(0).tetracyclines_doxycycline
      col 'ssi.5.ii.a.17.ii', p.ssi_questionnaire.get_appendix_antibiotics_at(0).tetracyclines_tetracycline
      col 'ssi.5.ii.a.18', p.ssi_questionnaire.get_appendix_antibiotics_at(0).antimycobacterial_drugs
      col 'ssi.5.ii.a.18.i', p.ssi_questionnaire.get_appendix_antibiotics_at(0).antimycobacterial_drugs_clofazimine
      col 'ssi.5.ii.a.18.ii', p.ssi_questionnaire.get_appendix_antibiotics_at(0).antimycobacterial_drugs_dapsone
      col 'ssi.5.ii.a.18.iii', p.ssi_questionnaire.get_appendix_antibiotics_at(0).antimycobacterial_drugs_capreomycin
      col 'ssi.5.ii.a.18.iv', p.ssi_questionnaire.get_appendix_antibiotics_at(0).antimycobacterial_drugs_cycloserine
      col 'ssi.5.ii.a.18.v', p.ssi_questionnaire.get_appendix_antibiotics_at(0).antimycobacterial_drugs_ethembutol
      col 'ssi.5.ii.a.18.vi', p.ssi_questionnaire.get_appendix_antibiotics_at(0).antimycobacterial_drugs_ethionamide
      col 'ssi.5.ii.a.18.vii', p.ssi_questionnaire.get_appendix_antibiotics_at(0).antimycobacterial_drugs_isoniazid
      col 'ssi.5.ii.a.18.viii', p.ssi_questionnaire.get_appendix_antibiotics_at(0).antimycobacterial_drugs_pyranizamide
      col 'ssi.5.ii.a.18.ix', p.ssi_questionnaire.get_appendix_antibiotics_at(0).antimycobacterial_drugs_rifampicin
      col 'ssi.5.ii.a.18.x', p.ssi_questionnaire.get_appendix_antibiotics_at(0).antimycobacterial_drugs_streptomycin
      col 'ssi.5.ii.a.19', p.ssi_questionnaire.get_appendix_antibiotics_at(0).others
      col 'ssi.5.ii.a.19.i', p.ssi_questionnaire.get_appendix_antibiotics_at(0).others_chloramphenicol
      col 'ssi.5.ii.a.19.ii', p.ssi_questionnaire.get_appendix_antibiotics_at(0).others_fosfomycin
      col 'ssi.5.ii.a.19.iii', p.ssi_questionnaire.get_appendix_antibiotics_at(0).others_metronidazole
      col 'ssi.5.ii.a.19.iv', p.ssi_questionnaire.get_appendix_antibiotics_at(0).others_trimethoprim
